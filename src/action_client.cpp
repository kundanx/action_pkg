...
namespace fibonacci_action
{
    ...
    public:
        ...
        explicit FibActionClient(const rclcpp::NodeOptions & options)
        ...
        void send_goal()
        {
            ...
            std::bind(&FibActionClient::goal_response_callback, this, _1);

            send_goal_options.feedback_callback =
            std::bind(&FibActionClient::feedback_callback, this, _1, _2);

            send_goal_options.result_callback =
            std::bind(&FibActionClient::result_callback, this, _1);
...
RCLCPP_COMPONENTS_REGISTER_NODE(fibonacci_action::FibActionClient)